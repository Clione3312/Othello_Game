...
public partial class Player2 : MonoBehaviour
{
    ...
    public StateMachine<Player2> stateMachine;
    ...
    void Start()
    {
        yourSprite = GameManager.I.enemySprite;
        enemySprite = GameManager.I.yourSprite;

        stateMachine = new StateMachine<Player2>(this);
